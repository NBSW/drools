...
//Support two ways to get edit json.
    ...
    if (EditJson) {
        ...
        //modal
        if (window.dialogArguments && window.dialogArguments.json) {
            EditJson = window.dialogArguments.json;
        } else {
...
function loadType() {
    ...
    //modal
    if (!currentType && window.dialogArguments && window.dialogArguments.type) {
        currentType = window.dialogArguments.type;
    }
    var url;
